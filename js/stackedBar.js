...
function updateStackedBar() {
    ...
    if (myStackedBar.dataType === 'top3') {
        ...
        document.getElementById('stackedBarTitle').innerText = 'Which Countries Produce the Most Winners?';
    }
    else {
        myStackedBar.dataType = 'top3'
        document.getElementById('stackedBarUpdateButton').innerText = 'Toggle to Winners';
        document.getElementById('stackedBarTitle').innerText = 'Which Countries Produce the Most Top 3 Finishers?';
    }
