class PopularityVis {
    ...
    initVis() {
        ...
        vis.margin = { top: 20, right: 190, bottom: 20, left: 150 };
        vis.width = document.getElementById(vis.parentElement).getBoundingClientRect().width - vis.margin.left - vis.margin.right;
        let heightReduction = 5;
    ...
    drawGridLines() {
        ...
        vis.gridlines.selectAll("line").remove();

        // Append new gridlines
        vis.gridlines.selectAll("line")
            .data(vis.y.ticks())
            .enter().append("line")
            ...
            .attr("y1", d => vis.y(d))
            .attr("y2", d => vis.y(d))
            .style("stroke", "#eaeaea") // Light grey color
    ...
    updateVis() {
        ...
        if(vis.svg.selectAll(".x-axis-label").empty()){
            vis.svg.append("text")
                ...
                .attr("x", vis.width)
                .attr("y", vis.height - 2) // Adjust this value to position the label correctly
        ...
        dotsF.enter().append("circle")
            ...
            .attr("r", 3)
            .attr("r", d => d.year.getFullYear() === vis.selectedYear ? 15 : 3)
            .style("fill", d => d.year.getFullYear() === vis.selectedYear ? "#8dae86" : "#6e4366");
        ...
        dotsM.enter().append("circle")
            ...
            .attr("r", 3)
            .attr("r", d => d.year.getFullYear() === vis.selectedYear ? 15 : 3)
            .style("fill", d => d.year.getFullYear() === vis.selectedYear ? "#8dae86" : "#2970c2");
    ...
    //this function is used in factVis.js
    resetToFullRange() {
        let vis = this;
        // Assuming that vis.dataF and vis.dataM are your full datasets
        vis.filteredDataF = vis.dataF;
        vis.filteredDataM = vis.dataM;

        // Reset the x-axis domain to the full extent of the data
        vis.x.domain(d3.extent([...vis.dataF, ...vis.dataM], d => d.year));
        vis.y.domain([0, d3.max([...vis.dataF, ...vis.dataM], d => d.count)]);
